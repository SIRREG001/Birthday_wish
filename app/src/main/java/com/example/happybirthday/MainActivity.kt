        ...
        setContent {
            HappyBirthdayTheme {
                ...
                Surface(
                    ...
                    //GreetingText(message = "Happy Birthday Reginald", from = "Myself", modifier = Modifier.padding(8.dp))
                    GreetingImage(message = stringResource(R.string.happy_birthday_text), from = stringResource(
                        R.string.letter_source_txt
                    )
                    )
...
fun BirthdayCardPreview() {
    HappyBirthdayTheme {
        //GreetingText(message = "Happy Birthday Reginald", from="Myself")
        GreetingImage(message = stringResource(R.string.happy_birthday_text), from = stringResource(
            R.string.letter_source_txt
        ))
    }
